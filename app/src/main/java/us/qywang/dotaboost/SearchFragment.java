...
public class SearchFragment extends Fragment {
    ...
    private RelativeLayout errorDisplay;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mListener != null) {
            mListener.onFragmentInteraction("Search Player");
        }
    ...
    @Override
     public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        errorDisplay = (RelativeLayout) getActivity().findViewById(R.id.errorDisplay);
